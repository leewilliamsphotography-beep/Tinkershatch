...
const TesterModule=(function(){
    ...
    function bc(){
        ...
        if(!msg)return;
        fetch('https://ntfy.sh/tinkers-hatch-live',{method:'POST',body:msg}).then(()=>{
            inp.value='';
            ToastModule.show('Message broadcasted successfully!')
    ...
    async function uploadPhoto(){
        ...
        if(caption){
            caption='_caption_'+caption.replace(/[^a-zA-Z0-9 ]/g,'').replace(/\s+/g,'-');
        }
